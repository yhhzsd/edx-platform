...
class TestCourseExportImport(LibraryTestCase):
    ...
    def _setup_source_course_with_library_content(self):
        """
        Creates a course with library content.
        """
        ItemFactory.create(
            category="problem",
        ...
        # Create a new course for importing the earlier course.
        ...
        lc_block = self._add_library_content_block(vertical, self.lib_key, publish_item=True)
    ...
    def test_library_content_on_course_export_import(self):
        """
